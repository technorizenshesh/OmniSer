...
public class AdapterAllPharmacy extends RecyclerView.Adapter<AdapterAllPharmacy.MyViewHolder> {

    Context mContext;
    ArrayList<ModelAllRes.Result> reslist;

    public AdapterAllPharmacy(Context mContext, ArrayList<ModelAllRes.Result> reslist) {
