...
public class AdapterHomePharmcy extends RecyclerView.Adapter<AdapterHomePharmcy.MyViewHolder> {

    Context mContext;
    ArrayList<ModelTopRatedRes.Result> reslist;

    public AdapterHomePharmcy(Context mContext, ArrayList<ModelTopRatedRes.Result> reslist) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if(data.getAccept_order_or_not().equals("true")) {
                mContext.startActivity(new Intent(mContext, PharmacyShopDetailActivity.class)
