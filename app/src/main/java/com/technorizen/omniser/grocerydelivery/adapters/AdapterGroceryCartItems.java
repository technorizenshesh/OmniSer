...
import com.technorizen.omniser.fooddelivery.adapters.AdapterEditFoodTopping;
...
public class AdapterGroceryCartItems extends RecyclerView.Adapter<AdapterGroceryCartItems.MyViewHolder> {
    ...
    public AdapterGroceryCartItems(Context mContext, ArrayList<ModelCartItems.Result> cartItemList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_grocery_cart,parent,false);
    ...
    private void openItemDetailDialog(ModelCartItems.Result data,int pos) {
        ...
        AdapterEdiGroceryOptions adapterFoodTopping = new AdapterEdiGroceryOptions(mContext,data.getTopingss(),data.getItem_details().getItem_price());
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equalsIgnoreCase("1")) {
                        ...
                        ((MyGroceryCartActivity)mContext).hideContinue(cartItemList);
                        notifyDataSetChanged();
                    } else {
                        notifyDataSetChanged();
                        Toast.makeText(mContext, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
