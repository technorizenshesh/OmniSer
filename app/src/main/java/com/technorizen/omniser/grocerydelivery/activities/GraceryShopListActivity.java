...
import com.technorizen.omniser.databinding.ActivityGraceryShopListBinding;
...
public class GraceryShopListActivity extends AppCompatActivity implements
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    Context mContext = GraceryShopListActivity.this;
    ActivityGraceryShopListBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_gracery_shop_list);
        ProjectUtil.changeStatusBarColor(GraceryShopListActivity.this);
    ...
    private void getAllFavoriteRes(Location location) {
        ...
        call = ApiFactory.loadInterface().getFavGrocery(String.valueOf(location.getLatitude()),
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("1")) {
                        ...
                        AdapterAllGrocery adapterAllGrocery = new AdapterAllGrocery(mContext, modelAllRes.getResult());
                        binding.rvAllRes.setLayoutManager(new LinearLayoutManager(mContext));
                        binding.rvAllRes.setAdapter(adapterAllGrocery);

                    } else {
                        AdapterAllGrocery adapterAllGrocery = new AdapterAllGrocery(mContext,null);
                        binding.rvAllRes.setLayoutManager(new LinearLayoutManager(mContext));
                        binding.rvAllRes.setAdapter(adapterAllGrocery);
                    }
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("1")) {
                        ...
                        AdapterHomeFoodCat adapterHomeFoodCat = new AdapterHomeFoodCat(mContext,
                                modelcat.getResult(),GraceryShopListActivity.this::getRestByCat);
                        binding.rvCategory.setAdapter(adapterHomeFoodCat);

                        getRestaurants(currentLocation,"20");
    ...
    void setCurrentLocation() {
        ...
        if (ActivityCompat.checkSelfPermission (
            ...
            ActivityCompat.requestPermissions(GraceryShopListActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},
                    REQUEST_CODE);
            return;
        }
...
//                  currentLocation.setLongitude(Double.parseDouble(modelLogin.getResult().getLon()));
                ...
                public void onResult(LocationSettingsResult result) {
                    ...
                    switch (status.getStatusCode()) {
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            Toast.makeText(GraceryShopListActivity.this, "GPS is not on", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                status.startResolutionForResult(GraceryShopListActivity.this, 1000);
                        ...
                        case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                            ...
                            Toast.makeText(GraceryShopListActivity.this, "Setting change not allowed", Toast.LENGTH_SHORT).show();
    ...
    private void getRestaurants(Location location,String id) {
        ...
        call = ApiFactory.loadInterface().getAllGroceryStore(String.valueOf(location.getLatitude())
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("1")) {
                        ...
                        AdapterAllGrocery adapterAllRes = new AdapterAllGrocery(mContext, modelAllRes.getResult());
                        binding.rvAllRes.setLayoutManager(new LinearLayoutManager(mContext));
                        binding.rvAllRes.setAdapter(adapterAllRes);

                    } else {
                        AdapterAllGrocery adapterAllRes = new AdapterAllGrocery(mContext,null);
                        binding.rvAllRes.setLayoutManager(new LinearLayoutManager(mContext));
                        binding.rvAllRes.setAdapter(adapterAllRes);
                    }
