...
public class AdapterPharmacyAds extends SliderViewAdapter<AdapterPharmacyAds.AdapterRecentAdsViewHolder> {

    Context mContext;
    ArrayList<Integer> adsList;

    public AdapterPharmacyAds(Context mContext, ArrayList<Integer> adsList) {
