...
public class AdapterCategoryAds extends
        SliderViewAdapter<AdapterCategoryAds.AdapterRecentAdsViewHolder> {

    Context mContext;
    ArrayList<Integer> adsList;

    public AdapterCategoryAds(Context mContext, ArrayList<Integer> adsList) {
