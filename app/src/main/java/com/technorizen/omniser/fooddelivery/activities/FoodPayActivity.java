...
import com.technorizen.omniser.databinding.ActivityFoodPayBinding;
...
public class FoodPayActivity extends AppCompatActivity {

    Context mContext = FoodPayActivity.this;
    ActivityFoodPayBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_food_pay);
        sharedPref = SharedPref.getInstance(mContext);
        modelLogin = sharedPref.getUserDetails(AppConstant.USER_DETAILS);
        ProjectUtil.changeStatusBarColor(FoodPayActivity.this);
    ...
    private void getResAcceptingOrderOrNot() {

        Call<ResponseBody> call = null;

        call = ApiFactory.loadInterface().getFoodStatus(resId);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("1")) {
                        ...
                        Log.e("hjasghdghj","status = " + status);
    ...
    private void init() {
        ...
        binding.rlDone.setOnClickListener(v -> {
            ...
            if(binding.cbCash.isChecked()) {
                ...
                param.put("type",AppConstant.FOOD);
...
//            }
    ...
    private void bookingApi(String payType) {
        ...
        Call<ResponseBody> call = ApiFactory.loadInterface().foodBookingApi(
                ...
                cartItemArray.toString(),devlat,devlon,currentDate,AppConstant.FOOD
        );
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equalsIgnoreCase("1")) {
                        //  ModelCartItems modelCartItems = new Gson().fromJson(stringResponse,ModelCartItems.class);
                        Toast.makeText(FoodPayActivity.this, getString(R.string.success), Toast.LENGTH_SHORT).show();
                        finish();
                        ...
                        Toast.makeText(FoodPayActivity.this, getString(R.string.insuffeient_amount), Toast.LENGTH_SHORT).show();
                    }
