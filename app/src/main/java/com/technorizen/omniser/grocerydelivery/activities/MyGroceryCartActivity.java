...
import com.technorizen.omniser.databinding.ActivityMyGroceryCartBinding;
...
public class MyGroceryCartActivity extends AppCompatActivity implements UpdateTotalPayInterface {

    Context mContext = MyGroceryCartActivity.this;
    ActivityMyGroceryCartBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_my_grocery_cart);
        sharedPref = SharedPref.getInstance(mContext);
        modelLogin = sharedPref.getUserDetails(AppConstant.USER_DETAILS);
        ProjectUtil.changeStatusBarColor(MyGroceryCartActivity.this);
    ...
    private void init() {
        ...
        binding.btnContinue.setOnClickListener(v -> {
            ...
            if(storeId == null) {
                ...
                startActivity(new Intent(mContext,SetGroceryFoodDeliveryActivity.class)
...
//      binding.itemPlusDevCharges.setText(AppConstant.DOLLER_SIGN + totalPlusDev);
    ...
    private void getCartDetailsApi() {
        ...
        Call<ResponseBody> call = ApiFactory.loadInterface().getCartItemsApi(modelLogin.getResult().getId(),AppConstant.GROCERY);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equalsIgnoreCase("1")) {
                        ...
                        AdapterGroceryCartItems adapterCartItems = new AdapterGroceryCartItems(mContext,modelCartItems.getResult());
