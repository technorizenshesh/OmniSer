...
public class AdapterGrceryCategoryList extends RecyclerView.Adapter<AdapterGrceryCategoryList.MyViewHolder> {
    ...
    public AdapterGrceryCategoryList(Context mContext, ArrayList<ModelResTypeItems.Result> reslist) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tvCatName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                row_index=position;
                ((GraceryShopDetailActivity)mContext).scrollItemToPosition(position);
