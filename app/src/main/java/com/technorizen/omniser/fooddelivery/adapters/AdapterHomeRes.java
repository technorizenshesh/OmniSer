...
public class AdapterHomeRes extends RecyclerView.Adapter<AdapterHomeRes.MyViewHolder> {

    Context mContext;
    ArrayList<ModelTopRatedRes.Result> reslist;

    public AdapterHomeRes(Context mContext, ArrayList<ModelTopRatedRes.Result> reslist) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Log.e("dsfdsfdsfds","position = " + position + "  " + data.getSetLike());
