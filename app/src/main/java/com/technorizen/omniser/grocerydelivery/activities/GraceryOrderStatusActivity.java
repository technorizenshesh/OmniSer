...
import com.technorizen.omniser.databinding.ActivityGraceryOrderStatusBinding;
...
public class GraceryOrderStatusActivity extends AppCompatActivity {

    Context mContext = GraceryOrderStatusActivity.this;
    ActivityGraceryOrderStatusBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_gracery_order_status);
        ProjectUtil.changeStatusBarColor(GraceryOrderStatusActivity.this);
