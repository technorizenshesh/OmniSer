...
public class AdapterAllGrocery extends RecyclerView.Adapter<AdapterAllGrocery.MyViewHolder> {

    Context mContext;
    ArrayList<ModelAllRes.Result> reslist;

    public AdapterAllGrocery(Context mContext, ArrayList<ModelAllRes.Result> reslist) {
