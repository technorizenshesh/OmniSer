...
import com.technorizen.omniser.databinding.ActivityGroceryPayBinding;
...
public class GroceryPayActivity extends AppCompatActivity {

    Context mContext = GroceryPayActivity.this;
    ActivityGroceryPayBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_grocery_pay);
        sharedPref = SharedPref.getInstance(mContext);
        modelLogin = sharedPref.getUserDetails(AppConstant.USER_DETAILS);
        ProjectUtil.changeStatusBarColor(GroceryPayActivity.this);
    ...
    private void init() {
        ...
        binding.rlDone.setOnClickListener(v -> {
            ...
            if(binding.cbCash.isChecked()) {
                ...
                param.put("type",AppConstant.GROCERY);
...
//            }
    ...
    private void bookingApi(String payType) {
        ...
        Call<ResponseBody> call = ApiFactory.loadInterface().foodBookingApi(
                ...
                cartItemArray.toString(),devlat,devlon,currentDate,AppConstant.GROCERY
        );
