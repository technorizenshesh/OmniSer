...
import com.technorizen.omniser.databinding.ActivityPharmacyOrderHistoryBinding;
...
public class PharmacyOrderHistoryActivity extends AppCompatActivity {

    Context mContext = PharmacyOrderHistoryActivity.this;
    ActivityPharmacyOrderHistoryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_pharmacy_order_history);
