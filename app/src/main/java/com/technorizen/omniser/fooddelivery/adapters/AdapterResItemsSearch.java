...
public class AdapterResItemsSearch extends
        RecyclerView.Adapter<AdapterResItemsSearch.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterResItemsSearch.MyViewHolder holder, int position) {
