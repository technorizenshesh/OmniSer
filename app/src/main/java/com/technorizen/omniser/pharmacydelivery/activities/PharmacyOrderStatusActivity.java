...
import com.technorizen.omniser.databinding.ActivityPharmacyOrderStatusBinding;
...
public class PharmacyOrderStatusActivity extends AppCompatActivity {

    Context mContext = PharmacyOrderStatusActivity.this;
    ActivityPharmacyOrderStatusBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_pharmacy_order_status);
        ProjectUtil.changeStatusBarColor(PharmacyOrderStatusActivity.this);
